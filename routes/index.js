...
//Portfoilio
router.get('/portfolio', forwardAuthenticated, (req, res) => res.render('portfolio'));

//fashion
router.get('/fashion', forwardAuthenticated, (req, res) => res.render('fashion'));

//interior
router.get('/interior-and-automative-designs', forwardAuthenticated, (req, res) => res.render('interior'));

//art
router.get('/art', forwardAuthenticated, (req, res) => res.render('arts'));

//luxury
router.get('/luxury-automobile', forwardAuthenticated, (req, res) => res.render('luxury'));

//entertainment
router.get('/entertainment', forwardAuthenticated, (req, res) => res.render('entertainment'));


//architecture
router.get('/architecture', forwardAuthenticated, (req, res) => res.render('architecture'));
